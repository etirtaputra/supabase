          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-800/50">
              {filtered.map((c) => {
                ...
                const rowReadiness = hasSpecs ? specReadiness(c.category, c.specifications as Record<string, unknown>) : null;
                  ...
                  {isSpecsOpen && hasSpecs && (() => {
                    ...
                    <tr className="bg-slate-900/40 border-t border-amber-500/10">
                      <td colSpan={visibleColCount} className="px-6 py-5">
                        {readiness.relevant && (
                          <div className={`mb-4 px-3 py-2 rounded-lg border text-xs font-semibold inline-flex items-center gap-2 ${
                            readiness.ready
                            ...
                            {readiness.ready ? (
                              ...
                              <>
                                ...
                                Not calculator-ready — missing: {readiness.missing.join(', ')}
                              </>
                            )}
                          </div>
                        )}
