    ...
    <div className="space-y-8">
      ...
      {selected && !hasData && (
        <div className="bg-slate-900/40 border border-slate-800/60 rounded-2xl p-8 text-center">
          ...
          <Link href="/purchasing?tab=market-intel" className="inline-block mt-4 px-4 py-2 bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-400 text-xs font-semibold rounded-lg transition-colors">
          ...
          <div className="bg-navy border border-slate-800/80 rounded-2xl overflow-hidden">
            ...
            <div className="px-5 py-4 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Link
                  href="/purchasing?tab=market-intel"
            ...
            {filteredCompPrices.length === 0 ? (
              <div className="p-8 text-center">
                ...
                {compPrices.length === 0 && (
                  <Link href="/purchasing?tab=market-intel" className="inline-block mt-3 px-4 py-2 bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-400 text-xs font-semibold rounded-lg transition-colors">
                    + Log competitor price
                  </Link>
                )}
              </div>
